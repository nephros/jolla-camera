    ...
    SilicaFlickable {
        ...
        Column {
            ...
            ComboBox {
                ...
                menu: ContextMenu {
                    Repeater {
                        model: [Camera.FlashAuto, Camera.FlashOff, Camera.FlashOn, Camera.FlashRedEyeReduction, Camera.FlashFill, Camera.FlashTorch, Camera.FlashVideoLight, Camera.FlashSlowSyncFrontCurtain, Camera.FlashSlowSyncRearCurtain, Camera.FlashManual]
            ...
            Column {
                ...
                DetailItem {
                    label: "Resolution"
                    value: camera.imageCapture.resolution.width + "x" + camera.imageCapture.resolution.height
                }
            ...
            Column {
                ...
                DetailItem {
                    label: "Resolution"
                    value: camera.videoRecorder.resolution.width + "x" + camera.videoRecorder.resolution.height
                }
            ...
            ComboBox {
                ...
                menu: ContextMenu {
                    Repeater {
                        model: [Camera.FocusManual, Camera.FocusHyperfocal, Camera.FocusInfinity, Camera.FocusAuto, Camera.FocusContinuous, Camera.FocusMacro]
            ...
            ComboBox {
                ...
                menu: ContextMenu {
                    Repeater {
                        model: [Camera.FocusPointAuto, Camera.FocusPointCenter, Camera.FocusPointFaceDetection, Camera.FocusPointCustom]
                        MenuItem {
            ...
            ComboBox {
                ...
                menu: ContextMenu {
                    Repeater {
                        model: [Camera.ExposureManual, Camera.ExposureAuto, Camera.ExposureNight, Camera.ExposureBacklight, Camera.ExposureSpotlight, Camera.ExposureSports, Camera.ExposureSnow, Camera.ExposureBeach, Camera.ExposureLargeAperture, Camera.ExposureSmallAperture, Camera.ExposurePortrait, Camera.ExposureAction, Camera.ExposureLandscape, Camera.ExposureNightPortrait, Camera.ExposureTheatre, Camera.ExposureSunset, Camera.ExposureSteadyPhoto, Camera.ExposureFireworks, Camera.ExposureParty, Camera.ExposureCandlelight, Camera.ExposureBarcode, Camera.ExposureFlowers, Camera.ExposureAR, Camera.ExposureHDR, Camera.ExposureCloseup, Camera.ExposureModeVendor]
                        MenuItem {
            ...
            */
            ...
            ComboBox {
                ...
                menu: ContextMenu {
                    Repeater {
                        model: [100, 200, 400, 800, 1600, 3200, 6400]
            ...
            ComboBox {
                ...
                menu: ContextMenu {
                    Repeater {
                        model: [Camera.MeteringMatrix, Camera.MeteringAverage, Camera.MeteringSpot]
            ...
            ComboBox {
                ...
                menu: ContextMenu {
                    Repeater {
                        model: [CameraImageProcessing.WhiteBalanceManual, CameraImageProcessing.WhiteBalanceAuto, CameraImageProcessing.WhiteBalanceSunlight, CameraImageProcessing.WhiteBalanceCloudy, CameraImageProcessing.WhiteBalanceShade, CameraImageProcessing.WhiteBalanceTungsten, CameraImageProcessing.WhiteBalanceFluorescent, CameraImageProcessing.WhiteBalanceFlash, CameraImageProcessing.WhiteBalanceSunset, CameraImageProcessing.WhiteBalanceVendor]
