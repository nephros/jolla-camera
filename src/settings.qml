...
SettingsBase {
    ...
    function exposureModeIcon(exposureMode) {
        switch (exposureMode) {
        case Camera.ExposureAuto:           return "image://theme/icon-camera-mode-automatic"
        case Camera.ExposureManual:         return "image://theme/icon-camera-mode-manual"
    ...
    function exposureModeText(exposureMode) {
        ...
        //% "Automatic exposure"
        case Camera.ExposureAuto:           return qsTrId("camera_settings-la-exposure-automatic")
        //: "Manual exposure mode"
        //% "Manual exposure"
        case Camera.ExposureManual:         return qsTrId("camera_settings-la-exposure-manual")
