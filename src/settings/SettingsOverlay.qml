...
PinchArea {
    ...
    property var _portraitPositions: [
        { "captureMode": overlayAnchorBL, "cameraPosition": overlayAnchorBR, "exposure": Qt.AlignRight, "backCameraToggle": Qt.AlignBottom  | Qt.AlignHCenter }, // buttonAnchorTL
        { "captureMode": overlayAnchorBL, "cameraPosition": overlayAnchorBR, "exposure": Qt.AlignRight, "backCameraToggle": Qt.AlignVCEnter | Qt.AlignRight   }, // buttonAnchorCL
        { "captureMode": overlayAnchorBR, "cameraPosition": overlayAnchorBC, "exposure": Qt.AlignRight, "backCameraToggle": Qt.AlignTop     | Qt.AlignHCenter }, // buttonAnchorBL
        { "captureMode": overlayAnchorBL, "cameraPosition": overlayAnchorBR, "exposure": Qt.AlignRight, "backCameraToggle": Qt.AlignTop     | Qt.AlignHCenter }, // buttonAnchorBC
        { "captureMode": overlayAnchorBL, "cameraPosition": overlayAnchorBC, "exposure": Qt.AlignRight, "backCameraToggle": Qt.AlignTop     | Qt.AlignHCenter }, // buttonAnchorBR
        { "captureMode": overlayAnchorBL, "cameraPosition": overlayAnchorBR, "exposure": Qt.AlignLeft,  "backCameraToggle": Qt.AlignVCEnter | Qt.AlignLeft    }, // buttonAnchorCR
        { "captureMode": overlayAnchorBL, "cameraPosition": overlayAnchorBR, "exposure": Qt.AlignLeft,  "backCameraToggle": Qt.AlignBottom  | Qt.AlignHCenter }, // buttonAnchorTR
    ]
    property var _landscapePositions: [
        { "captureMode": overlayAnchorBL, "cameraPosition": overlayAnchorCL, "exposure": Qt.AlignRight, "backCameraToggle": Qt.AlignVCenter | Qt.AlignRight   }, // buttonAnchorTL
        { "captureMode": overlayAnchorBL, "cameraPosition": overlayAnchorTL, "exposure": Qt.AlignRight, "backCameraToggle": Qt.AlignVCenter | Qt.AlignRight   }, // buttonAnchorCL
        { "captureMode": overlayAnchorCL, "cameraPosition": overlayAnchorTL, "exposure": Qt.AlignRight, "backCameraToggle": Qt.AlignVCenter | Qt.AlignRight   }, // buttonAnchorBL
        { "captureMode": overlayAnchorBR, "cameraPosition": overlayAnchorTR, "exposure": Qt.AlignLeft,  "backCameraToggle": Qt.AlignTop     | Qt.AlignHCenter }, // buttonAnchorBC
        { "captureMode": overlayAnchorCR, "cameraPosition": overlayAnchorTR, "exposure": Qt.AlignLeft,  "backCameraToggle": Qt.AlignVCenter | Qt.AlignLeft    }, // buttonAnchorBR
        { "captureMode": overlayAnchorBR, "cameraPosition": overlayAnchorTR, "exposure": Qt.AlignLeft,  "backCameraToggle": Qt.AlignVCEnter | Qt.AlignLeft    }, // buttonAnchorCR
        { "captureMode": overlayAnchorBR, "cameraPosition": overlayAnchorCR, "exposure": Qt.AlignLeft,  "backCameraToggle": Qt.AlignVCEnter | Qt.AlignLeft    }, // buttonAnchorTR
    ]
    ...
    CameraDeviceToggle {
        parent: shutterContainer
        opacity: _commonControlOpacity
        visible: opacity > 0.0 && !!model && model.length > 1 && Settings.deviceId !== camera.frontFacingDeviceId && !inButtonLayout
        ...
        y: {
            ...
            if (_overlayPosition.backCameraToggle & Qt.AlignTop) {
                return -height - (overlay.isPortrait ? 3 : 1) * Theme.paddingLarge
            } else if (_overlayPosition.backCameraToggle & Qt.AlignBottom) {
                return parent.height + Theme.paddingLarge
            } else {
